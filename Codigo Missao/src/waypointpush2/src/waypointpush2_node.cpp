...
int main(int argc, char **argv)
{
    ...
    waypointPusher(wayPusher, pushClient, nh, mavros_msgs::Waypoint::FRAME_GLOBAL_REL_ALT, mavros_msgs::CommandCode::NAV_TAKEOFF, false, true, 0, 0, 0, 0, 40.6340638, -8.6605780, 5);

		waypointPusher(wayPusher, pushClient, nh, mavros_msgs::Waypoint::FRAME_GLOBAL_REL_ALT, mavros_msgs::CommandCode::NAV_WAYPOINT, false, true, 10, 0, 0, 0, 40.633841, -8.660694, 7);

		 waypointPusher(wayPusher, pushClient, nh, mavros_msgs::Waypoint::FRAME_GLOBAL_REL_ALT, mavros_msgs::CommandCode::NAV_WAYPOINT, false, true, 8, 0, 0, 0, 40.633774, -8.660396, 10);

waypointPusher(wayPusher, pushClient, nh, mavros_msgs::Waypoint::FRAME_GLOBAL_REL_ALT, mavros_msgs::CommandCode::NAV_WAYPOINT, false, true, 8, 0, 0, 0, 40.633998, -8.660289, 12);


		waypointPusher(wayPusher, pushClient, nh, mavros_msgs::Waypoint::FRAME_GLOBAL_REL_ALT, mavros_msgs::CommandCode::NAV_LAND, false, true, 0, 0, 0, 0, 40.6338368,-8.6601062, 5);
